...
public class EventListener implements Listener {
    ...
    public void register() {
        Bukkit.getPluginManager().registerEvents(this, DeathManager.instance);
    }
    ...
    public void handlerDeaths(PlayerDeathEvent e) {
        ...
        if (deathMessage != null) {
            ...
            getLogger().info("[DeathManager] Сообщение о смерти игрока " + victim.getName() + " было убрано, т.к. оно было пустым.");
        }
